...
for i in range(6):
    ...
    num    = minlab.shape[1] * minlab.shape[2] * minlab.shape[3] // 128 ** 3 # mini label
    save(minlab, 128, 128, 128, 'croppeddata', label=True, num=i*num)
"""
...
for i in range(6):
    ...
    save(blur, 128, 128, 128, 'croppeddata', name=f'_x{scale}', scale=scale, num=i*num)
